...
--
-- Dumping data for table `public_room`
--

LOCK TABLES `public_room` WRITE;
/*!40000 ALTER TABLE `public_room` DISABLE KEYS */;
/*!40000 ALTER TABLE `public_room` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-17  9:03:16
