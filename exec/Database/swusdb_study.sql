...
CREATE TABLE `study` (
  ...
  `now_core_time` int DEFAULT NULL,
  `now_total_time` int DEFAULT NULL,
...
INSERT INTO `study` VALUES (1,0,11,120),(2,0,24,60),(3,0,4,0),(4,0,14,90),(5,0,101,70),(6,0,568,270),(16,0,5,240),(74,0,0,242),(164,0,1,0),(166,0,0,0),(217,0,7,0);
...
-- Dump completed on 2023-02-17  9:03:41
