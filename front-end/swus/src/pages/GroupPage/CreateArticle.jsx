...
function CreateArticleForm() {
  ...
  const onHandleSubmit = (event) => {
    ...
    if (!inputs.category.replace(blank, "")) {
      ...
      Number(
        inputs.startTime.replace(/:/gi, "") >
          Number(inputs.finishTime.replace(/:/gi, ""))
      )
    ) {
      ...
      Number(
        inputs.beginAt.replace(/-/gi, "") >
          Number(inputs.endAt.replace(/-/gi, ""))
      )
    ) {
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              <FormControlLabel
                ...
                value={inputs.days[0]}
                control={
                  <Checkbox checked={inputs.days[0]} onChange={onHandleInput} />
                }
              />
              <FormControlLabel
                name="day1"
                ...
                value={inputs.days[1]}
                control={
                  <Checkbox checked={inputs.days[1]} onChange={onHandleInput} />
                }
              />
              <FormControlLabel
                name="day2"
                ...
                value={inputs.days[2]}
                control={
                  <Checkbox checked={inputs.days[2]} onChange={onHandleInput} />
                }
              />
              <FormControlLabel
                name="day3"
                ...
                value={inputs.days[3]}
                control={
                  <Checkbox checked={inputs.days[3]} onChange={onHandleInput} />
                }
              />
              <FormControlLabel
                name="day4"
                ...
                value={inputs.days[4]}
                control={
                  <Checkbox checked={inputs.days[4]} onChange={onHandleInput} />
                }
              />
              <FormControlLabel
                name="day5"
                ...
                value={inputs.days[5]}
                control={
                  <Checkbox checked={inputs.days[5]} onChange={onHandleInput} />
                }
              />
              <FormControlLabel
                name="day6"
                ...
                value={inputs.days[6]}
                control={
                  <Checkbox checked={inputs.days[6]} onChange={onHandleInput} />
                }
              />
            </div>
          </Grid>
