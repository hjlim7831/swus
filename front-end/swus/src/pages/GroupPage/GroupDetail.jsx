...
function GroupDetail() {
  ...
  const teamId = window.location.pathname.slice(
    21,
  ...
  function getWeekTopics() {
    if (
      Array.isArray(teamDetails.todolist) &&
      teamDetails.todolist.length > 0
    ) {
          ...
          >
            <Grid container sx={{ px: 2, paddingTop: 2 }}>
              <Grid item xs={6} sx={{ display: "flex", alignItems: "center" }}>
                <p style={{ fontWeight: "bold", fontSize: "25px" }}>
                  ...
                  {teamDetails.team_done === "Y" ? (
                    <span style={{ marginInline: 10, color: "red" }}>
                      [완료]
                    </span>
                  ) : null}
                </p>
            ...
            <Grid container sx={{ padding: 2 }}>
              ...
              <Divider
                ...
                flexItem
                sx={{ background: "grey", borderWidth: 1, marginInline: 3 }}
              />
              <Grid
                item
                xs={7}
            ...
            <Divider
              ...
              flexItem
              sx={{ background: "grey", borderWidth: 1 }}
            />
            <Grid container sx={{ padding: 2 }}>
              <Grid container sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Grid item xs={3}>
                  ...
                  >
                    <p style={{ textAlign: "center", marginInline: 5 }}>
                      {getStudyDays()}{" "}
                    </p>
                    <p style={{ textAlign: "center", marginInline: 5 }}>
                ...
                <Grid item xs={1}>
                  ...
                  >
                    {teamDetails.team_number} / {teamDetails.recruitment_number}
                  </p>
                </Grid>
              </Grid>
              <Container sx={{ height: "500px", overflowY: "scroll" }}>
                ...
                <br />
                <Container>{getWeekTopics()}</Container>
              </Container>
            </Grid>
          </Container>
          <Dialog
