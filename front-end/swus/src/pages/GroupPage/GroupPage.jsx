...
function GroupPage() {
  ...
  return (
    <>
      <Container
        sx={{ border: "1px gray solid", borderRadius: "10px", height: "85vh", marginTop: 3 }}
      >
        <Grid
          container
          style={{
          ...
          <Table style={{ textAlign: "center" }}>
            <TableHead>
              <TableRow>
                ...
                ></TableCell>
                <TableCell style={{ fontSize: "22px", fontWeight: "bold", textAlign: "center" }}>
                  그룹 종류
                </TableCell>
                <TableCell style={{ fontSize: "22px", fontWeight: "bold", textAlign: "center" }}>
                  제목
            ...
            <TableBody style={{ textAlign: "center" }}>
              {articles.slice(page * 10, (page + 1) * 10).map((article) => (
                <TableRow key={uuidv4()}>
                  <TableCell
                    style={{
                      justifyItems: "center",
                  ...
                  <TableCell sx={{ align: "justify", justifyContent: "center" }}>
                    <span
                      style={{
                        fontWeight: "bold",
                        textAlign: "center",
                  ...
                  <TableCell
                    ...
                    onClick={() => {
                      goArticleDetail(article.board_id);
                    }}
                  >
                    <span style={{ cursor: "pointer" }}>{article.title}</span>
                  </TableCell>
                  <TableCell style={{ textAlign: "center" }}>
                    {article.recruitment_done === "Y" ? "📢 모집 중" : "✅ 모집 완료"}
                  </TableCell>
