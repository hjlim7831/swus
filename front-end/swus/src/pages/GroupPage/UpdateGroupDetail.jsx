  ...
  useEffect(() => {
    ...
    axios(config).then((response) => {
      ...
      for (let i = 0; i < plannedTodos.length; i++) {
        newTodos.push({
          round: plannedTodos[i].id_round,
          content: plannedTodos[i].content,
        });
      ...
      >
        <form>
          ...
          <Divider
            ...
            flexItem
            sx={{ borderBottomWidth: 3, backgroundColor: "gray" }}
          />
          <Grid
            container
            sx={{
          ...
          <Divider orientation="horizontal" flexItem />
          <Container
            style={{ overflowY: "scroll", height: "200px", marginBottom: 10 }}
          >
            <Grid
              container
              style={{
            ...
            <Grid
              container
              sx={{ justifyContent: "center", display: "flex", marginBlock: 3 }}
            >
              <Icon
                color="primary"
                sx={{ cursor: "pointer" }}
